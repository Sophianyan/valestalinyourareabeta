...
let james = new Queen("King Tyra", 14, 10, 12, 6, 12, 10, 14, 12, 8, 1, 4, "James", "James", "US2", false);
...
let aimee = new Queen("Aimee Yonce Shennel", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Aimee", "Aimee", "CA4", false);
let aurora = new Queen("Aurora Matrix", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Aurora", "Aurora", "CA4", false);
let denim = new Queen("Denim", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Denim", "Denim", "CA4", false);
let kiki = new Queen("Kiki Coe", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Kiki", "Kiki", "CA4", false);
let kitten = new Queen("Kitten Kaboodle", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Kitten", "Kitten", "CA4", false);
let luna = new Queen("Luna DuBois", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Luna", "Luna", "CA4", false);
let melinda = new Queen("Melinda Verga", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Melinda", "Melinda", "CA4", false);
let nearah = new Queen("Nearah Nuff", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Nearah", "Nearah", "CA4", false);
let sisi = new Queen("Sisi Superstar", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Sisi", "Sisi", "CA4", false);
let girlfriend = new Queen("The Girlfriend Experience", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Girlfriend", "Girlfriend", "CA4", false);
let V = new Queen("Venus", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "V", "V", "CA4", false);
...
let gingerJ = new Queen("Ginger Johnson", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "GingerJ", "GingerJ", "UK5", false);
let kate = new Queen('Kate Butch', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Kate', 'Kate', "UK5", false);
let tomara = new Queen("Tomara Thomas", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Tomara', 'Tomara', 'UK5', false);
let cara = new Queen('Cara Melle', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Cara', 'Cara', 'UK5', false);
let michael = new Queen('Michael Marouli', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Michael", "Michael", 'UK5', false);
let dede = new Queen('DeDeLicious', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "DeDe", "DeDe", "UK5", false);
let vicki = new Queen('Vicki Vivacious', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Vicki', 'Vicki', 'UK5', false);
let banksie = new Queen('Banksie', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Banksie', 'Banksie', 'UK5', false);
let missNaomi = new Queen('Miss Naomi Carter', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "MissNaomi", "MissNaomi", "UK5", false);
let alexisSaint = new Queen('Alexis Saint-Pete', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'AlexisSaint', 'AlexisSaint', 'UK5', false);
...
let silvana = new Queen("Silvana della Magliana", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, "Silvana", "Silvana","IT3",false);
let lina = new Queen("Lina Galore", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Lina', 'Lina', 'IT3', false);
let prada = new Queen("La Prada", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Prada', 'Prada', 'IT3', false);
let leila = new Queen("Leila Yarn", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Leila', 'Leila', 'IT3', false);
let melissaBian = new Queen("Melissa Bianchini", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Melissa', 'Melissa', 'IT3', false);
let sheeva = new Queen("La Sheeva", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Sheeva', 'Sheeva', 'IT3', false);
let sypario = new Queen("Sypario", 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Sypario', 'Sypario', 'IT3', false);
let sissy = new Queen('Sissy Lea', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Sissy', 'Sissy', 'IT3', false);
let morgana = new Queen('Morgana Cosmica', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Morgana', 'Morgana', 'IT3', false);
let lightning = new Queen('Lightning Aurora', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Lightning', 'Lightning', 'IT3', false);
let vezirja = new Queen('Vezirja', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Vezirja', 'Vezirja', 'IT3', false);
let amy = new Queen('Amy Krania', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Amy', 'Amy', 'IT3', false);
let adrianaPi = new Queen('Adriana Picasso', 7, 7, 7, 7, 7, 7, 7, 7, 7, 2, 2, 'Adriana', 'Adriana', 'IT3', false);
...
let FL3 = shuffle([sophia, rainbow, valestal, brianna, xuan, radio, juvie, linx, yitzu, coochie, millieDollars, tommy, willowfl3]);
        ...
        else
        {
            if(TopsQueens.indexOf(Tops[randomtop]) != -1)
            {
                if(( Tops[randomtop] === TopsQueens[0]|| (Tops[randomtop] === TopsQueens[1] && doublewin == true)) && CurrentChallenge.winner == false)
                {
                  ...
                  {
                    if(CurrentSeason.currentCast.length>4)
                    {
                      if((CurrentSeason.episodes.length > 2 && CurrentSeason.premiereformat != "S6") && (CurrentSeason.premiereformat != "S6" && CurrentSeason.episodes.length <= 7) || (CurrentSeason.premiereformat == "S6" && CurrentSeason.episodes.length <= 5))
                      {
                          Tops[randomtop].immune.push(CurrentSeason.episodes.length+1);
                          Main.createText(Tops[randomtop].GetName()+", you have won immunity for next week.","Bold");
                      }
